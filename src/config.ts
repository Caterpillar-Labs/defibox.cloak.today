const defaultAliasAuthority = import.meta.env.VITE_ALIAS_AUTHORITY || "thezeosproxy@public";
...
export const APP_CONFIG = {
  ...
  aliasAuthority: defaultAliasAuthority,
  aliasContract:
    import.meta.env.VITE_ALIAS_CONTRACT ||
    defaultAliasAuthority.split("@")[0] ||
    "thezeosproxy",
